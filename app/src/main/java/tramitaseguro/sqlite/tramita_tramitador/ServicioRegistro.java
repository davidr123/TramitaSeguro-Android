...
public class ServicioRegistro extends AsyncTask<Void, Void, String> {
    ...
    public ServicioRegistro(Context context,  String linkAPI,  String name,  String email,  String password) {
    ...
    protected void onPreExecute(){
        super.onPreExecute();
        progressDialog=ProgressDialog.show(httpContext, "Realizando Registro", "por favor, espere");
    }
